...
import {AppliedOperator, RequestResult} from '../types';
...
class RecipeDialog extends React.PureComponent<
  RecipeDialogProps,
  RecipeDialogState
> {
              ...
              <div>
                ...
                >
                  {result.columns.map((colName, idx) => (
                    <MenuItem key={'menuitem_' + idx} value={idx}>
                      {colName}
                    </MenuItem>
                  ))}
                </Select>
                ...
                >
                  {result.library &&
                    result.library.functions.map((lib, idx) => (
                      <MenuItem key={'menuitem_lib_' + idx} value={idx}>
                        {lib.name}
                      </MenuItem>
                    ))}
                </Select>
