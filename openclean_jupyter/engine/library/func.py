...
from openclean_jupyter.engine.store.serialized import ObjectSerializer, JsonSerializer
...
class FunctionHandle:
    ...
    def from_dict(doc: Dict) -> FunctionHandle:
        ...
        Returns
        -------
        openclean_jupyter.engine.library.func.FunctionHandle
        """
...
class FunctionSerializer(ObjectSerializer):
    ...
    def __init__(self, serializer: Optional[ObjectSerializer] = None):
        ...
        Parameters
        ----------
        serializer: openclean_jupyter.engine.store.serialized.ObjectSerializer,
                default=None
    ...
    def serialize(self, object: FunctionHandle) -> str:
        ...
        Parameters
        ----------
        object: openclean_jupyter.engine.library.func.FunctionHandle
