...
class SerializedObjectHandle(ObjectHandle):
    ...
    def __init__(
        ...
        name: string
            Unique object name.
        store: openclean_jupyter.engine.store.serialized.SerializedObjectStore
    ...
    @staticmethod
    def from_dict(
        doc: Dict, store: SerializedObjectStore, serializer: ObjectSerializer
        ...
        Returns
        -------
        openclean_jupyter.engine.store.serialized.SerializedObjectHandle
        """
